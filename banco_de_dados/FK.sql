...
produto(idProduto);
/*compra*/
ALTER TABLE compra ADD CONSTRAINT FK_COMPRA_CARRINHO FOREIGN KEY(token_cart) REFERENCES
carrinho(tokenCart);
ALTER TABLE compra ADD CONSTRAINT FK_COMPRA_INSTITUICAO FOREIGN KEY(id_inst) REFERENCES
intstuicoes(idInst);
ALTER TABLE compra ADD CONSTRAINT FK_COMPRA_VENDEDOR FOREIGN KEY(id_comprador) REFERENCES
Usuario(idUsuario);

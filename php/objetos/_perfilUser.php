<?php
    /*
        ...
        tipo_anuncio - este campo irá nos informar qual o tipo de anuncio o vendedor optou para publicar seu produto.
            -Preciso de ajudar para definir os nomes destes tipos kkkk to sem criatividade. 


        Missão:

        1) Criarmos visões que procure na tabela comentarios, os comentarios pertecentes aos produtos que o usuario logado esteja anunciando.
            a) dentro da sessão, ja estamos guardando o id do usuario. Então fica mais facil realizar esta procura.
        
        2) Elaborar consultra na tabela de produtos para atualizar o numero de anuncios ativos, inativos e em conclusão.

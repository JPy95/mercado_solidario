...
function valida_nome(){
    ...
    if(nome.value.length >= 8){
        ...
        document.getElementById('erro-nome').innerHTML = "Favor preencher seu nome e sobrenome.";
    }
    return false;
}
//Bloqueia o usuario digitar um cpf menor que 11 digitos ou maior que 11 digitos.
function valida_cpf(){
...
function valida_pass(){
    ...
    if (pass.value.length >= 8) {
        ...
        document.getElementById('erro-pass').innerHTML = "A senha deve conter no minimo 8 letras.";
    }
    return false;
}
...
function valida_check_pass(){
    ...
    if (confirma_pass.value == document.getElementById('pass').value) {
        ...
        document.getElementById('erro-confirma_pass').innerHTML = "As senhas devem ser iguais.";
    }
    return false;
}
